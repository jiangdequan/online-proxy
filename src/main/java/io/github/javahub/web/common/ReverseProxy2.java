...
public class ReverseProxy2 {
    ...
    public ReverseProxy2(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
                         String remoteUrl, OkHttpClient okHttpClient) {
        this.host = remoteUrl.replace("https://", "").replace("http://", "");
